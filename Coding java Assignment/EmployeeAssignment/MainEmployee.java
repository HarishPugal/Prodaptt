...
public class MainEmployee {
	...
	public static void main(String[] args) {
		...
		List<Employee> employeeslist = Arrays.asList(emp1,emp2,emp3,emp4,emp5,emp6,emp7,emp8,emp9,emp10);
		for(Employee employee:employeeslist) {
			addemp.addEmployee(employee);
		}
		System.out.println(addemp.readallEmployee());
		System.out.println(addemp.getEmployee(12));
	}
